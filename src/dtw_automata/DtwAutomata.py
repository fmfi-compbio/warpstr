...
from src.dtw_automata.plotter import plot_collapsed, plot_summaries, save_warp_img
...
def dtw_wrapper(input_data):
    ...
    state_raws, state_val, state_exp = warper.create_alignment(
        rescaling_config['method'], rescaling_config['reps_as_one'])
    ...
    resc_state_raws, resc_state_val, resc_state_exp = resc_warper.create_alignment(
        rescaling_config['method'], rescaling_config['reps_as_one'])
