...
with open(args.file, 'r') as file:
    ...
    for row in csvreader:
        ...
        print(fast5file.keys())
        print(fast5file[readfullname].keys())
        print(fast5file[readfullname]['Analyses'].keys())
        print(fast5file[readfullname]['Analyses']['Basecall_1D_000'].keys())
        print(fast5file[readfullname]['Analyses']['Segmentation_000'].keys())
...
print(f'Continue with calling "python WarpSTR.py {args.config}" \
    where steps "single_read_extraction", "guppy_annotation" and "tr_region_extraction" are set to "False"')
